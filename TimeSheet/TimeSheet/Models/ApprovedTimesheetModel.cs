...
{
    public class ApprovedTimesheetModel
    {
        public List<ApprovedTimesheetModel> ApprovedTimeSheetListt { get; set; }
        public ApprovedTimesheetModel()
        {
            ApprovedTimeSheetListt = new List<ApprovedTimesheetModel>();
        }
